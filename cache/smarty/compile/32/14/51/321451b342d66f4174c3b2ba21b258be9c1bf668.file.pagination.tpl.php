<?php /* Smarty version Smarty-3.1.19, created on 2015-11-23 11:49:13
         compiled from "D:\xampp\htdocs\store\themes\transformer\pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2990456526289415891-84187672%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '321451b342d66f4174c3b2ba21b258be9c1bf668' => 
    array (
      0 => 'D:\\xampp\\htdocs\\store\\themes\\transformer\\pagination.tpl',
      1 => 1447993228,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2990456526289415891-84187672',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565262896629c4_34711319',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565262896629c4_34711319')) {function content_565262896629c4_34711319($_smarty_tpl) {?>
...
" rel="prev">&laquo;&nbsp;<span><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</span></a></li>
				<?php } else { ?>
					<li id="pagination_previous<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)) {?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
<?php }?>" class="disabled pagination_previous"><span>&laquo;&nbsp;<span><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</span></span></li>
				<?php }?>
...
" rel="next"><span><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</span>&nbsp;&raquo;</a></li>
				<?php } else { ?>
					<li id="pagination_next<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)) {?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
<?php }?>" class="disabled pagination_next"><span><span><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</span>&nbsp;&raquo;</span></li>
				<?php }?>
			</ul>
		<?php }?>
	    <?php if ($_smarty_tpl->tpl_vars['nb_products']->value>$_smarty_tpl->tpl_vars['products_per_page']->value&&$_smarty_tpl->tpl_vars['start']->value!=$_smarty_tpl->tpl_vars['stop']->value) {?>
	    	<?php if (Configuration::get('STSN_CATEGORY_SHOW_ALL_BTN')) {?>
