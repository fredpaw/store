<?php /* Smarty version Smarty-3.1.19, created on 2015-12-18 16:31:17
         compiled from "D:\xampp\htdocs\store\modules\stadvancedmenu\views\templates\admin\_configure\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2545356739a25623af5-83327656%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b33ea52c28db5655c9350669d60bdfd4bb67cc57' => 
    array (
      0 => 'D:\\xampp\\htdocs\\store\\modules\\stadvancedmenu\\views\\templates\\admin\\_configure\\helpers\\form\\form.tpl',
      1 => 1449038239,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2545356739a25623af5-83327656',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56739a27ad2b42_38996227',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56739a27ad2b42_38996227')) {function content_56739a27ad2b42_38996227($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'D:\\xampp\\htdocs\\store\\tools\\smarty\\plugins\\function.counter.php';
?>
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?> fontello_wrap">
 ...
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['medias']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['media']->key => $_smarty_tpl->tpl_vars['media']->value) {
$_smarty_tpl->tpl_vars['media']->_loop = true;
?>
					<div class="col-xs-4 col-sm-3">
						<label data-html="true" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php if ($_smarty_tpl->tpl_vars['media']->value=='lg') {?><?php echo smartyTranslate(array('s'=>'Desktops (>1200px)'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='md') {?><?php echo smartyTranslate(array('s'=>'Desktops (>992px)'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='sm') {?><?php echo smartyTranslate(array('s'=>'Tablets (>768px)'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='xs') {?><?php echo smartyTranslate(array('s'=>'Phones (>480px)'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='xxs') {?><?php echo smartyTranslate(array('s'=>'Phones (<480px)'),$_smarty_tpl);?>
<?php }?>"><?php if ($_smarty_tpl->tpl_vars['media']->value=='lg') {?><?php echo smartyTranslate(array('s'=>'Large devices'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='md') {?><?php echo smartyTranslate(array('s'=>'Medium devices'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='sm') {?><?php echo smartyTranslate(array('s'=>'Small devices'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='xs') {?><?php echo smartyTranslate(array('s'=>'Extra small devices'),$_smarty_tpl);?>
<?php } elseif ($_smarty_tpl->tpl_vars['media']->value=='xxs') {?><?php echo smartyTranslate(array('s'=>'Extremely small devices'),$_smarty_tpl);?>
<?php }?></label>
...
" class="fixed-width-md">
            			<?php $_smarty_tpl->tpl_vars['foo'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['foo']->step = 1;$_smarty_tpl->tpl_vars['foo']->total = (int) ceil(($_smarty_tpl->tpl_vars['foo']->step > 0 ? $_smarty_tpl->tpl_vars['input']->value['values']['maximum']+1 - (1) : 1-($_smarty_tpl->tpl_vars['input']->value['values']['maximum'])+1)/abs($_smarty_tpl->tpl_vars['foo']->step));
...
" class="btn btn-default" data-toggle="modal" href="#" data-target="#modal_fontello">
				<i class="<?php echo $_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']];?>
"></i><?php echo smartyTranslate(array('s'=>'Edit'),$_smarty_tpl);?>
...
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['class']->value, ENT_QUOTES, 'UTF-8', true);?>
...
/font/fontello.eot?123');
				  src: url('<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['module_name'];?>
../../themes/<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['theme_name'];?>
/font/fontello.eot#iefix?123') format('embedded-opentype'),
				       url('<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['module_name'];?>
../../themes/<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['theme_name'];?>
/font/fontello.woff?123') format('woff'),
				       url('<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['module_name'];?>
../../themes/<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['theme_name'];?>
/font/fontello.ttf?123') format('truetype'),
				       url('<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['module_name'];?>
../../themes/<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['theme_name'];?>
/font/fontello.svg#fontello?123') format('svg');
				  font-weight: normal;
				  font-style: normal;
				}
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '2545356739a25623af5-83327656');
content_56739a2722f071_69258444($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-12-18 16:31:19
         compiled from "D:\xampp\htdocs\store\admin907ta1wcy\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_56739a2722f071_69258444')) {function content_56739a2722f071_69258444($_smarty_tpl) {?>
