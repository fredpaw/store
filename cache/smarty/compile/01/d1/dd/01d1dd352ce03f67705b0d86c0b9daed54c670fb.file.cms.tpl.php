<?php /* Smarty version Smarty-3.1.19, created on 2015-12-18 12:06:31
         compiled from "D:\xampp\htdocs\store\themes\transformer\cms.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2790056735c179f2326-02554225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01d1dd352ce03f67705b0d86c0b9daed54c670fb' => 
    array (
      0 => 'D:\\xampp\\htdocs\\store\\themes\\transformer\\cms.tpl',
      1 => 1449038236,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2790056735c179f2326-02554225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56735c17cb7570_46415387',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56735c17cb7570_46415387')) {function content_56735c17cb7570_46415387($_smarty_tpl) {?>
...
" name="lnk_view" class="button btn btn-default"/>
	...
	<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','function'=>"displayCmsMainSlide",'identify'=>$_smarty_tpl->tpl_vars['cms']->value->id,'mod'=>'stowlcarousel','caller'=>'stowlcarousel'),$_smarty_tpl);?>

    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','function'=>"displayCmsMainSlide",'identify'=>$_smarty_tpl->tpl_vars['cms']->value->id,'mod'=>'stcameraslideshow','caller'=>'stcameraslideshow'),$_smarty_tpl);?>

    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','function'=>"displayCmsMainSlide",'identify'=>$_smarty_tpl->tpl_vars['cms']->value->id,'mod'=>'stiosslider','caller'=>'stiosslider'),$_smarty_tpl);?>

    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','function'=>"displayCmsMainSlide",'identify'=>$_smarty_tpl->tpl_vars['cms']->value->id,'mod'=>'stadvancedbanner','caller'=>'stadvancedbanner'),$_smarty_tpl);?>
...
<?php } elseif (isset($_smarty_tpl->tpl_vars['cms_category']->value)) {?>
	<div class="block-cms">
		<h1 class="heading page-heading"><a href="<?php if ($_smarty_tpl->tpl_vars['cms_category']->value->id==1) {?><?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
...
<?php }?>"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cms_category']->value->name, ENT_QUOTES, 'UTF-8', true);?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['cms_category']->value->description)&&$_smarty_tpl->tpl_vars['cms_category']->value->description) {?>
			<div class="block"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cms_category']->value->description, ENT_QUOTES, 'UTF-8', true);?>
</div>
		<?php }?>
		<?php if (isset($_smarty_tpl->tpl_vars['sub_category']->value)&&!empty($_smarty_tpl->tpl_vars['sub_category']->value)) {?>	
			<h3 class="heading page-heading"><?php echo smartyTranslate(array('s'=>'List of sub categories in %s:','sprintf'=>$_smarty_tpl->tpl_vars['cms_category']->value->name),$_smarty_tpl);?>
</h3>
			<ul class="bullet">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subcategory']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
		...
		<h3 class="heading page-heading"><?php echo smartyTranslate(array('s'=>'List of pages in %s:','sprintf'=>$_smarty_tpl->tpl_vars['cms_category']->value->name),$_smarty_tpl);?>
</h3>
			<ul class="bullet">
