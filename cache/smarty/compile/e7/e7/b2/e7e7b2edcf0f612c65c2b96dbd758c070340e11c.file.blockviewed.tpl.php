<?php /* Smarty version Smarty-3.1.19, created on 2015-11-23 11:49:11
         compiled from "D:\xampp\htdocs\store\themes\transformer\modules\blockviewed\blockviewed.tpl" */ ?>
<?php /*%%SmartyHeaderCode:172056526287df0849-73755966%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7e7b2edcf0f612c65c2b96dbd758c070340e11c' => 
    array (
      0 => 'D:\\xampp\\htdocs\\store\\themes\\transformer\\modules\\blockviewed\\blockviewed.tpl',
      1 => 1447993228,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '172056526287df0849-73755966',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56526287ec4ea7_01527112',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56526287ec4ea7_01527112')) {function content_56526287ec4ea7_01527112($_smarty_tpl) {?>

<?php $_smarty_tpl->_capture_stack[0][] = array("thumb_default_width", null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getWidthSize'][0][0]->getWidth(array('type'=>'thumb_default'),$_smarty_tpl);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("thumb_default_height", null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHeightSize'][0][0]->getHeight(array('type'=>'thumb_default'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
...
?>
				<li class="pro_column_box clearfix<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['last']) {?> last_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['first']) {?> first_item<?php } else { ?> item<?php }?>">
					<a
...
" >
						...
						src="<?php if (isset($_smarty_tpl->tpl_vars['viewedProduct']->value->id_image)&&$_smarty_tpl->tpl_vars['viewedProduct']->value->id_image) {?><?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['viewedProduct']->value->link_rewrite,$_smarty_tpl->tpl_vars['viewedProduct']->value->cover,'thumb_default');?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['img_prod_dir']->value;?>
<?php echo $_smarty_tpl->tpl_vars['lang_iso']->value;?>
-default-thumb_default.jpg<?php }?>" 
						alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['viewedProduct']->value->legend, ENT_QUOTES, 'UTF-8', true);?>
" 
						width="<?php echo Smarty::$_smarty_vars['capture']['thumb_default_width'];?>
" height="<?php echo Smarty::$_smarty_vars['capture']['thumb_default_height'];?>
" />
					</a>
