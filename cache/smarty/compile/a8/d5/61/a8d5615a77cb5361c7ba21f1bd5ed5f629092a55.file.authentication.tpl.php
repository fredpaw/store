<?php /* Smarty version Smarty-3.1.19, created on 2015-12-18 12:24:03
         compiled from "D:\xampp\htdocs\store\themes\transformer\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1978656736033b0b503-96408006%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8d5615a77cb5361c7ba21f1bd5ed5f629092a55' => 
    array (
      0 => 'D:\\xampp\\htdocs\\store\\themes\\transformer\\authentication.tpl',
      1 => 1449038236,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1978656736033b0b503-96408006',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56736034795124_28857709',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56736034795124_28857709')) {function content_56736034795124_28857709($_smarty_tpl) {?>
...
<h1 class="heading"><?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)) {?><?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
...
?>
	...
	<?php }?>-->
	<?php $_smarty_tpl->_capture_stack[0][] = array("oneallsociallogin", null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','mod'=>'oneallsociallogin','caller'=>'oneallsociallogin'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
...
" method="post" id="create-account_form" class="">
			<section class="block">
				<h3 class="title_block"><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</h3>
				<div class="form_content <?php if (isset(Smarty::$_smarty_vars['capture']['oneallsociallogin'])&&trim(Smarty::$_smarty_vars['capture']['oneallsociallogin'])) {?> has_social_login <?php }?>">
				<div class="form_content_inner clearfix">
					<p class="mar_b1"><?php echo smartyTranslate(array('s'=>'Please enter your email address to create an account.'),$_smarty_tpl);?>
</p>
...
<?php }?>" />
            	...
            	<?php if (isset(Smarty::$_smarty_vars['capture']['oneallsociallogin'])&&trim(Smarty::$_smarty_vars['capture']['oneallsociallogin'])) {?>
            		<?php echo Smarty::$_smarty_vars['capture']['oneallsociallogin'];?>
...
" /><?php }?>
					<button class="btn btn-medium btn_primary" type="submit" id="SubmitCreate" name="SubmitCreate">
...
" method="post" id="login_form" class="">
			<section class="block">
				<h3 class="title_block"><?php echo smartyTranslate(array('s'=>'Already registered?'),$_smarty_tpl);?>
</h3>
				<div class="form_content <?php if (isset(Smarty::$_smarty_vars['capture']['oneallsociallogin'])&&trim(Smarty::$_smarty_vars['capture']['oneallsociallogin'])) {?> has_social_login <?php }?>">
            	<div class="form_content_inner clearfix">
					<div class="form-group">
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
				...
				<div class="submit">
					<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
					<button type="submit" id="SubmitLogin" name="SubmitLogin" class="btn btn-medium btn_primary">
...
" method="post" id="new_account_form" class="std clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</h3>
...
<?php }?>" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
					...
					<?php if ($_smarty_tpl->tpl_vars['dniExist']->value==false) {?>
						<div class="required form-group dni">
							<label for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<input type="text" class="text form-control" name="dni_invoice" id="dni_invoice" value="<?php if (isset($_POST['dni'])&&$_POST['dni']) {?><?php echo $_POST['dni'];?>
<?php }?>" />
							<span class="form_info"><?php echo smartyTranslate(array('s'=>'DNI / NIF / NIE'),$_smarty_tpl);?>
</span>
						</div>
...
&nbsp;&nbsp;</option>
			...
			<?php if (isset($_smarty_tpl->tpl_vars['newsletter']->value)&&$_smarty_tpl->tpl_vars['newsletter']->value) {?>
				<div class="checkbox">
					...
					<?php if (isset($_smarty_tpl->tpl_vars['field_required']->value)&&array_key_exists('newsletter',$_smarty_tpl->tpl_vars['field_required']->value)) {?>
						<sup> *</sup>
					<?php }?>
				</div>
			<?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['optin']->value)&&$_smarty_tpl->tpl_vars['optin']->value) {?>
				<div class="checkbox">
					...
					<?php if (isset($_smarty_tpl->tpl_vars['field_required']->value)&&array_key_exists('optin',$_smarty_tpl->tpl_vars['field_required']->value)) {?>
						<sup> *</sup>
					<?php }?>
				</div>
			<?php }?>
...
" rel="nofollow" class="but but-default"><?php echo smartyTranslate(array('s'=>'Back'),$_smarty_tpl);?>
</a>
		</div>
	</form>
<?php }?>
