<?php /* Smarty version Smarty-3.1.19, created on 2015-12-02 16:56:51
         compiled from "D:\xampp\htdocs\store\themes\transformer\contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:819565e8823d03e32-14260535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68d54ca072c98ee5ed6e1fbd05e550b0fdcb959f' => 
    array (
      0 => 'D:\\xampp\\htdocs\\store\\themes\\transformer\\contact-form.tpl',
      1 => 1447993228,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '819565e8823d03e32-14260535',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565e88240a6850_54428107',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565e88240a6850_54428107')) {function content_565e88240a6850_54428107($_smarty_tpl) {?>
...
<?php } else { ?>
	...
	<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','location'=>"96",'mod'=>'steasycontent','caller'=>'steasycontent'),$_smarty_tpl);?>
...
" method="post" class="contact-form-box" enctype="multipart/form-data">
		<fieldset>
			<h3 class="page-subheading hidden"><?php echo smartyTranslate(array('s'=>'send a message'),$_smarty_tpl);?>
</h3>
			<div class="row">
...
<?php }?></textarea>
			...
			<div class="submit">
				<button type="submit" name="submitMessage" id="submitMessage" class="btn btn-default"><?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
</button>
			</div>
		</fieldset>
	</form>
	<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','location'=>"95",'mod'=>'steasycontent','caller'=>'steasycontent'),$_smarty_tpl);?>
