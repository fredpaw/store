...
<dl id="currencies_block_top" class="{if isset($istopbar) && $istopbar}{if isset($currencies_position) && $currencies_position} pull-right{else} pull-left{/if}{/if} dropdown_wrap">
