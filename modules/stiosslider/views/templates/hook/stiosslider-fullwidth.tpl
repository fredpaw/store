...
<div id="iosSlider_{$slide.id_st_iosslider_group}" class="iosSlider fullwidth_default mar_b2 {if $slide['location']!=14 && $slide['hide_on_mobile']} hidden-xs {/if} ">
    <div class="slider clearfix">
        ...
        {foreach $slide['slide'] as $banner}
            <div id="iosSliderBanner_{$banner.id_st_iosslider}" style="height:{if $slide.height}{$slide.height}{else}500{/if}px;" class="iosSlideritem">
                ...
                <div class="{if $slide['location']==1} container {else} container_flex {/if}">
    ...
    {if $slide.prev_next}
	<div id="iosSliderPrev_{$slide.id_st_iosslider_group}" class="iosSlider_prev {if $slide.prev_next==2 || $slide.prev_next==4} hidden-xs {/if} {if $slide.prev_next==3 || $slide.prev_next==4} showonhover {/if}"><i class="icon-angle-left"></i></div>
	<div id="iosSliderNext_{$slide.id_st_iosslider_group}" class="iosSlider_next {if $slide.prev_next==2 || $slide.prev_next==4} hidden-xs {/if} {if $slide.prev_next==3 || $slide.prev_next==4} showonhover {/if}"><i class="icon-angle-right"></i></div>
    {/if}
    {if $slide.pag_nav}
