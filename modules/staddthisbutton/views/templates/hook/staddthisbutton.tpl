...
<a class="addthis_button mar_b1" href="http://www.addthis.com/bookmark.php?v=300&amp;pubid={if $addthis_pubid}{$addthis_pubid}{else}xa-516bd81b706fd972{/if}"><img src="http://s7.addthis.com/static/btn/v2/lg-share-en.gif" width="125" height="16" alt="Bookmark and Share" style="border:0"/></a>
{if $addthis_pubid}<script type="text/javascript">{literal}var addthis_config = {"data_track_addressbar":true};{/literal}</script>{/if}
