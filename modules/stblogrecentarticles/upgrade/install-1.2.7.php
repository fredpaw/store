...
function upgrade_module_1_2_7($object)
{
    ...
    $result &= Configuration::updateValue('STSN_BHOME_RB_PRO_PER_LG_0', 2);
    $result &= Configuration::updateValue('STSN_BHOME_RB_PRO_PER_MD_0', 1);
    $result &= Configuration::updateValue('STSN_BHOME_RB_PRO_PER_SM_0', 1);
    $result &= Configuration::updateValue('STSN_BHOME_RB_PRO_PER_XS_0', 1);
    $result &= Configuration::updateValue('STSN_BHOME_RB_PRO_PER_XXS_0', 1);
    $result &= Configuration::updateValue('STSN_HOME_RB_PRO_PER_LG_0', 4);
    $result &= Configuration::updateValue('STSN_HOME_RB_PRO_PER_MD_0', 4);
    $result &= Configuration::updateValue('STSN_HOME_RB_PRO_PER_SM_0', 3);
    $result &= Configuration::updateValue('STSN_HOME_RB_PRO_PER_XS_0', 2);
    $result &= Configuration::updateValue('STSN_HOME_RB_PRO_PER_XXS_0', 1);
