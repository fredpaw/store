...
{/if}
		<a id="shopping_cart" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart_mod'}" rel="nofollow" class="shopping_cart clearfix header_item">
			...
			<span class="ajax_cart_split ajax_cart_middle">{l s='-' mod='blockcart_mod'}</span>
		...
		<div class="layer_inner_box">
			...
			<div class="layer_details">
				...
				<div class="button-container clearfix">
					<span class="continue btn btn-default pull-left" title="{l s='Continue shopping' mod='blockcart_mod'}">
						{l s='Continue shopping' mod='blockcart_mod'}
					</span>
					<a class="btn btn-default pull-right" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart_mod'}" rel="nofollow">
						{l s='Proceed to checkout' mod='blockcart_mod'}
					</a>
				</div>
			</div>
		</div>
