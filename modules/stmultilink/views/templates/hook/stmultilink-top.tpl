...
{foreach $link_groups as $link_group}
    <dl id="multilink_{$link_group.id_st_multi_link_group}" class="stlinkgroups_top {if $link_group.location==9}pull-left{elseif $link_group.location==1}pull-right{/if} dropdown_wrap {if $link_group@first}first-item{/if} {if $link_group.hide_on_mobile} hidden-xs {/if}">
