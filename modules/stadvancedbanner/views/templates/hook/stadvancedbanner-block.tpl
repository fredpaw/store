{if $banner_data['url']}
    <a id="st_advanced_banner_block_{$banner_data['id_st_advanced_banner']}" href="{$banner_data['url']|escape:'html'}" class="st_advanced_banner_block_{$banner_data['id_st_advanced_banner']} st_advanced_banner_block" target="{if $banner_data['new_window']}_blank{else}_self{/if}" title="{$banner_data['title']|escape:'htmlall':'UTF-8'}" style="height:{$banner_height}px;">
{else}
    <div id="st_advanced_banner_block_{$banner_data['id_st_advanced_banner']}" class="st_advanced_banner_block_{$banner_data['id_st_advanced_banner']} st_advanced_banner_block" style="height:{$banner_height}px;">
{/if}
