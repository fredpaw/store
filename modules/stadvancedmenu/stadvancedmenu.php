            ...
            if(is_array($data) && count($data))
                foreach($data as $v)
                {
                    ...
                    if($v['bg_image'])
                    {
                        ...
                        $custom_css .= '#st_advanced_menu_'.$v['id_st_advanced_menu'].' .stadvancedmenu_sub{background-image:url('.$bg_img.');';
                        switch($v['bg_repeat']) {
                            case 1 :
                    ...
                    if($v['bg_margin_bottom'])
                        $custom_css .= '#st_advanced_menu_'.$v['id_st_advanced_menu'].' .stadvancedmenu_sub{padding-bottom:'.($v['bg_margin_bottom']+20).'px;}';
