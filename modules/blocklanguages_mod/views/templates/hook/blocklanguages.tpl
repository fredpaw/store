...
<dl id="languages-block-top" class="languages-block {if isset($istopbar) && $istopbar}{if isset($languages_position) && $languages_position} pull-right{else} pull-left{/if}{/if} dropdown_wrap">
