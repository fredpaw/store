...
*}
<h1 class="page-heading">{l s='Cart Summary'}</h1>
    ...
    <table id="cart_summary" class="table table-bordered resp_table {if $PS_STOCK_MANAGEMENT}stock-management-on{else}stock-management-off{/if}">
        ...
        {if $use_taxes}
            {if $priceDisplay}
                <tr class="cart_total_price">
                    ...
                    <td colspan="{if $PS_STOCK_MANAGEMENT}3{else}2{/if}" class="text-right">{if $display_tax_label}{l s='Total products (tax excl.)'}{else}{l s='Total products'}{/if}</td>
            ...
            {else}
                <tr class="cart_total_price">
                    ...
                    <td colspan="{if $PS_STOCK_MANAGEMENT}3{else}2{/if}" class="text-right">{if $display_tax_label}{l s='Total products (tax incl.)'}{else}{l s='Total products'}{/if}</td>
        ...
        {else}
            <tr class="cart_total_price">
                ...
                <td colspan="{if $PS_STOCK_MANAGEMENT}3{else}2{/if}" class="text-right">{l s='Total products'}</td>
                <td colspan="2" class="price" id="total_product">{displayPrice price=$total_products}</td>
            </tr>
        {/if}
...
<p class="cart_navigation clearfix">
    ...
    {/if}
    <a href="{$back_link|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn btn-default pull-left">
        {l s='Continue shopping'}
    </a>
    <button data-show-if-js="" style="" id="confirmOrder" type="button" class="button btn btn-default standard-checkout pull-right">{l s='Order With Obligation To Pay'}</button>
</p>
