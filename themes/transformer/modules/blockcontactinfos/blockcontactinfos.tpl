...
<section id="block_contact_infos" class="block footer-block col-xs-12 col-sm-3">
    ...
    <ul class="toggle-footer footer_block_content">
        {if $blockcontactinfos_company != ''}
        	<li>
        		<i class="icon-map-marker"></i>{$blockcontactinfos_company|escape:'html':'UTF-8'}{if $blockcontactinfos_address != ''}, {$blockcontactinfos_address|escape:'html':'UTF-8'|nl2br}{/if}
        	</li>
        {/if}
