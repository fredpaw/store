...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"image": {$link->getImageLink($product.link_rewrite, $product.id_image, 'thumb_default')|json_encode},
        "image_width":	 "{getWidthSize type='thumb_default'}",
        "image_height":	 "{getHeightSize type='thumb_default'}",
