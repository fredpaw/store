...
<div id="mywishlist">
	...
	{if $id_customer|intval neq 0}
		<form method="post" class="std box" id="form_wishlist">
			<fieldset>
				...
				<p class="submit">
                    <button id="submitWishlist" class="btn btn-default" type="submit" name="submitWishlist">
	...
	<ul class="footer_links clearfix">
		<li class="pull-left">
			<a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='blockwishlist'}" rel="nofollow">
				<i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='blockwishlist'}
			</a>
		</li>
		<li class="pull-right">
			<a href="{$base_dir}" title="{l s='Home' mod='blockwishlist'}" rel="nofollow">
				<i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='blockwishlist'}
			</a>
		</li>
	</ul>
</div>
