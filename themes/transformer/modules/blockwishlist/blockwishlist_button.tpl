...
{else}
<div class="wishlist">
	<a class="addToWishlist wishlistProd_{$product.id_product|intval}" href="#" rel="nofollow" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1, this); return false;"  data-pid="{$product.id_product|intval}">
		{l s="Add to Wishlist" mod='blockwishlist'}
	</a>
</div>
{/if}