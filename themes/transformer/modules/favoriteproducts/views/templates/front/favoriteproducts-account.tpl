...
<div id="favoriteproducts_block_account">
	...
	<ul class="footer_links clearfix">
		<li class="pull-left">
			<a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='favoriteproducts'}" rel="nofollow">
				<i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='favoriteproducts'}
			</a>
		</li>
		<li class="pull-right">
			<a href="{$base_dir}" title="{l s='Home' mod='favoriteproducts'}" rel="nofollow">
				<i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='favoriteproducts'}
			</a>
		</li>
	</ul>
</div>