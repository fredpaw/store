		...
		<ul class="pro_column_list">
        	<li class="pro_column_box clearfix">
            	<a class="pro_column_left products-block-image" href="{$special.link|escape:'html':'UTF-8'}">
                    ...
                    src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'thumb_default')|escape:'html':'UTF-8'}" 
                    alt="{$special.legend|escape:'html':'UTF-8'}" 
                    title="{$special.name|escape:'html':'UTF-8'}" 
                    width="{$smarty.capture.thumb_default_width}" 
                    height="{$smarty.capture.thumb_default_height}"/>
                </a>
