...
{else}
	{if $nbManufacturers > 0}
		...
		{capture name="manufacturer_default_width"}{getWidthSize type='manufacturer_default'}{/capture}
		{capture name="manufacturer_default_height"}{getHeightSize type='manufacturer_default'}{/capture}
