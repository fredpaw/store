...
<form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="std" id="form_forgotpassword">
	<fieldset>
		...
		<p class="submit">
            <button type="submit" class="btn btn-default">{l s='Retrieve Password'}</button>
		</p>
	</fieldset>
</form>
{/if}
...
<ul class="clearfix footer_links">
	<li><a class="btn btn-default" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow">{l s='Back to Login'}</a></li>
</ul>
